...
pub enum Commands {
    ...
    #[command(about = "Pack a directory", long_about = "Compress and deduplicate a directory into a .squish archive file")]
    Pack {
        input: String,
        #[clap(short, long)]
    ...
    #[command(about = "List files in an archive", long_about = "Display the contents of a .squish archive")]
    List {
        squish: String,
    ...
    #[command(about = "Extract archive contents", long_about = "Unpacks all files from a .squish archive into a target directory")]
    Unpack {
        squish: String,
        #[clap(short, long)]
        output: Option<String>,
